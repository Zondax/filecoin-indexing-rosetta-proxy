...
//   - name string
//   - location string
func (_e *DataStoreMock_Expecter) DeleteFiles(name any, location any) *DataStoreMock_DeleteFiles_Call {
...
//   - name string
//   - location string
func (_e *DataStoreMock_Expecter) GetFile(name any, location any) *DataStoreMock_GetFile_Call {
...
//   - dir string
//   - prefix string
func (_e *DataStoreMock_Expecter) List(dir any, prefix any) *DataStoreMock_List_Call {
...
//   - dir string
//   - prefix string
func (_e *DataStoreMock_Expecter) ListChan(ctx any, dir any, prefix any) *DataStoreMock_ListChan_Call {
...
//   - newName string
//   - bucket string
func (_e *DataStoreMock_Expecter) RenameFile(oldName any, newName any, bucket any) *DataStoreMock_RenameFile_Call {
...
//   - destFolder string
//   - destName string
func (_e *DataStoreMock_Expecter) UploadFromBytes(data any, destFolder any, destName any) *DataStoreMock_UploadFromBytes_Call {
...
//   - filePath string
//   - dest string
func (_e *DataStoreMock_Expecter) UploadFromFile(filePath any, dest any) *DataStoreMock_UploadFromFile_Call {
...
//   - destFolder string
//   - destName string
func (_e *DataStoreMock_Expecter) UploadFromReader(data any, size any, destFolder any, destName any) *DataStoreMock_UploadFromReader_Call {
